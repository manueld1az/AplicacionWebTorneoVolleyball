...
<body>
    ...
    <main class="container main">
        ...
        <div class="container">
            <h3 class="tittleMain">Encuentros Semifinales</h3>
        </div>
        ...
        // SE CONSULTAN LOS EQUIPOS CLASIFICADOS
            $sql =" SELECT Nombre_Equipo, Cod_Equipo
                    ...
                    WHERE semifinales is not null ORDER BY semifinales;";
        ...
        // PARA ORGANIZAR LOS ENCUENTROS DE LAS SIGUIENTES RONDAS
            $sql =" SELECT  MAX(Cod_Encuentro) AS ultimoCodigo,
                    ...
                    FROM torneovoleibol.encuentro WHERE Cod_Encuentro < 61;";
            $consulta = mysqli_query($conexion, $sql);
                    ...
                    <thead>
                        <tr>
                            ...
                            <td class="columnaCabecera">
                                <p>
                                    <b>
                                        <center>Encuentro <?php echo $numeroEncuentro[$i]; ?>
                                        </center>
                                    </b>
                                </p>
                            </td>
    ...
    <?php
        ...
        // SE VALIDA SI YA SE HAN CREADO LOS ENCUENTROS DE ESTA RONDA
            ...
            if ($encuentros[1]['codigoEncuentro'] == 62) {
