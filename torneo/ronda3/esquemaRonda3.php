...
<body>
  ...
  <main class="container main">
    <div class="container">
      <h3 class="tittleMain">Cuartos de Final</h3>
    </div>
    ...
    <div class="row">
      <?php
        ...
        for ($i=48; $i <= 55; $i++) {
          ...
          $sql = "SELECT Nombre_Equipo FROM `equipos` WHERE cuartos IS NOT NULL ORDER BY cuartos;";
          $consulta = $conexion->query($sql);
      ...
      $contador = 0;
      $nombreGrupos = ["LLAVE UNO", "LLAVE DOS", "LLAVE TRES", "LLAVE CUATRO"];
      for ($i = 0; $i < 4; $i++) {
          if ($i %2 == 0 && $i != 0) {
              $contador += 2;
          } elseif ($i %2 != 0) {
