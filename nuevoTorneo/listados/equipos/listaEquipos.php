      ...
      <table class="table table-hover">
        ...
        <tbody>
          <tr>
            ...
            <td>
              <center><?php echo $mostrar['Nombre_Colegio'] ?>
              </center>
            </td>
            <td>
              <center><?php echo $mostrar['Nombre_Equipo'] ?>
              </center>
            </td>
            <td>
              <center>
                <a href="actualizarEquipos.php?Cod_Equipo=<?php echo $mostrar['Cod_Equipo'] ?> "
                  title="Editar" aria-hidden="true"><i class="fas fa-edit botonEditar"></i></a>
                <a href="eliminarEquipos.php?Cod_Equipo=<?php echo $mostrar['Cod_Equipo'] ?>"
                  title="Eliminar" name="Cod_Equipo" aria-hidden="true" class="botonEliminar"><i
