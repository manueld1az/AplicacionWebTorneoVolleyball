...
<head>
    ...
    <title>Tabla Mejores Jugadoras del Torneo</title>
...
<body>
    ...
    <main class="container main">
        <div class="container">
            <h3 class="tittleMain">
                Tabla Mejores Jugadoras del Torneo
                <a href="../estadisticas/estadisticaEquipo.php">
                <h6>Ver Estadisticas de Equipos</h6>
                </a>
            </h3>
        </div>
