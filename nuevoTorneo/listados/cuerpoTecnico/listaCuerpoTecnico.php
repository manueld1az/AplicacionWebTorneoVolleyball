...
<body>
  <header class="container">
    <div class="row">
      ...
      <div class="col-auto">
        <a href="../../registros/cuerpoTecnico/registrarCuerpoTecnico.html">
          <button class="btn button2" type="button">
            <b><i class="fas fa-plus-circle"></i> Tecnico</b>
          </button>
        </a>
      </div>
    </div>
  ...
  <main class="container main">
    <div class="container">
      <h3 class="tittleMain">Lista de Cuerpo Técnico</h3>
    </div>
    ...
    <div class="table-responsive">
      <table class="table table-hover">
        ...
        <tbody>
          <tr>
            <td>
              <center><?php echo $mostrar['id_Cuerpotecnico'] ?>
              </center>
            </td>
            <td>
            ...
            <td>
              <center>
                <a href="actualizarCuerpoTecnico.php?id_Cuerpotecnico=<?php echo $mostrar['id_Cuerpotecnico'] ?> "
                  title="Editar" aria-hidden="true"><i class="fas fa-edit botonEditar"></i></a>
                <a href="eliminarCuerpoTecnico.php?id_Cuerpotecnico=<?php echo $mostrar['id_Cuerpotecnico'] ?>"
                  title="Eliminar" name="id_Cuerpotecnico" aria-hidden="true" class="botonEliminar"><i
