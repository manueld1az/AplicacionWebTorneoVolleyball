...
<body>
  ...
  <main class="container main">
    <div class="container">
      <h3 class="tittleMain">Finales</h3>
    </div>
    ...
    <div class="row">
      <?php
        ...
        for ($i=59; $i <= 61; $i++) {
          ...
          $sql = "SELECT Nombre_Equipo FROM `equipos` WHERE finales IS NOT NULL ORDER BY finales;";
          $consulta = $conexion->query($sql);
      ...
      $contador = 0;
      $nombreGrupos = ["Final", "Tercer puesto"];
      for ($i = 0; $i < 2; $i++) {
          if ($i %2 == 0 && $i != 0) {
              $contador += 2;
          } elseif ($i %2 != 0) {
