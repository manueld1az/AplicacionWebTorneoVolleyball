<?php
    ...
    $sql="SELECT rondaActual FROM torneo WHERE idTorneo = 1193;";    /* SE DEBE CAMBIAR EL ID DE TORNEO 1193 POR UNA VARIABLE QUE RECIBA EL ID DEL TORNEO CREADO POR EL USUARIO */
