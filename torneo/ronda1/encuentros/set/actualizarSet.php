...
<body>
    ...
    <main class="container main">
        <div class="container">
            <h3 class="tittleMain">Modificar Set</h3>
        </div>
            ...
            <table class="table">
                ...
                <?php
                    ...
                    while ($mostrar = mysqli_fetch_assoc($consulta)) {
                        ?>
                <tbody>
                    <form class="row g-3 needs-validation" novalidate action="registrarActualizarSet.php" method="POST">
                        <input type="hidden" name="NumeroRegistro" class="form-control" id="validationCustom01" min="0"
                        ...
                        <tr>
                            <td>
                                <center>
                                    <input type="number" class="form-control"
                                        value="<?php echo $mostrar['Cod_Set'] ?>"
                                        disabled />
                                </center>
                            </td>
                            <td>
                            ...
                            <td>
                                <center>
                                    <input type="number" name="Ptos_Equipo1" class="form-control"
                            ...
                            <td>
                                <center>
                                    <input type="number" class="form-control" name="Ptos_Equipo2"
                                        id="validationCustom01" min="0"
                            ...
                            <td>
                                <center>
                                    ...
                                    <a href="listarSet.php" title="Cancelar" id="botonesLista">
