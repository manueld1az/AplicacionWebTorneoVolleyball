    ...
    <body>
        <header class="container">
            <div class="row">
                ...
                <div class="col-auto">
                    <a href="../registroEncuentros/puntos/puntos.html">
                    <button class="btn button2" type="button">
                        <b><i class="fas fa-plus-circle"></i>Puntos</b>
                    </button>
                    </a>
                </div>
            </div>
        ...
        <main class="container main">
            <div class="container">
                <h3 class="tittleMain">Lista de Puntage </h3>
            </div>
                ...
                <table class="table table-hover">
                    ...
                    ?>
                        <tbody>
                            <tr>
                                <td>
                                    <center><?php echo $mostrar['puntos'] ?></center>
                                </td>
                                <td>
                                    <center><?php echo $mostrar['idJugadora'] ?></center>
                                </td>
                                <td>
                                    <center><?php echo $mostrar['codigoEquipo'] ?></center>
                                </td>
                                <td>
                                    <center><?php echo $mostrar['codigoEncuentro'] ?></center>
                                </td>
                                <td>
                                    <center><?php echo $mostrar['codigoSet'] ?></center>
                                </td>
                                <td>
                                    <center>
                                        <a
                                        href="actualizarPuntos.php?NumeroRegistro=<?php echo $mostrar['NumeroRegistro'] ?> "
                                        title="Editar"
                                        aria-hidden="true">
                                        <i class="fas fa-edit botonEditar"></i>
                                        </a>
                                        <a
                                        href="eliminarPuntos.php?NumeroRegistro=<?php echo $mostrar['NumeroRegistro'] ?>"
                                        title="Eliminar"
                                        name="NumeroRegistro"
                                        aria-hidden="true"
                                        class="botonEliminar">
