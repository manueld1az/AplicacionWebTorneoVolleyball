    ...
    <div class="table-responsive">
      <table class="table">
        ...
        <tbody>
          <tr>
            <td>
              <center><?php echo $mostrar['idJuez'] ?>
              </center>
            </td>
            <td>
            ...
            <td>
              <center>
                <a href="actualizarJueces.php?idJuez=<?php echo $mostrar['idJuez'] ?> "
                  title="Editar" aria-hidden="true"><i class="fas fa-edit botonEditar"></i></a>
                <a href="eliminarJueces.php?numeroRegistro=<?php echo $mostrar['numeroRegistro'] ?>"
