      ...
      <div class="table-responsive">
        ...
        ?>
          <tbody>
            <tr>
              <td>
                <center><?php echo $mostrar['id_Cuerpotecnico'] ?></center>
              </td>
              <td>
                <center><?php echo $mostrar['Nombre'] ?></center>
              </td>
              <td>
                <center><?php echo $mostrar['Cargo'] ?></center>
              </td>
              <td>
              ...
              <td>
                <center>
                  <a
                    href="actualizarCuerpoTecnico.php?id_Cuerpotecnico=<?php echo $mostrar['id_Cuerpotecnico'] ?> "
                    title="Editar"
                    aria-hidden="true"
                    ><i class="fas fa-edit botonEditar"></i
                  ></a>
                  <a
                    href="eliminarCuerpoTecnico.php?id_Cuerpotecnico=<?php echo $mostrar['id_Cuerpotecnico'] ?>"
                    title="Eliminar"
